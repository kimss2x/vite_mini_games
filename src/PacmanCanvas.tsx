...
const PacmanCanvas: React.FC = () => {
  ...
  const ghostsRef = useRef<Ghost[]>([
    { x: 7, y: 5, dx: 0, dy: 0, color: '#f00', release: 0 },
    { x: 7, y: 5, dx: 0, dy: 0, color: '#ffb8ff', release: 10 },
    { x: 7, y: 5, dx: 0, dy: 0, color: '#0ff', release: 20 },
    { x: 7, y: 5, dx: 0, dy: 0, color: '#ffa500', release: 30 },
  ]);
