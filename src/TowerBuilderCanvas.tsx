...
const TowerBuilderCanvas: React.FC<{ width?: number; height?: number }> = ({ width = 300, height = 500 }) => {
  ...
  const bottomInfo = 'Space/Enter/클릭: 블록 놓기\nR: 리셋';

  return (
    <GameLayout title="🏗️ Tower Builder" topInfo={topInfo} bottomInfo={bottomInfo}>
      <GameCanvas ref={canvasRef} width={width} height={height} gameTitle="Tower Builder" />
    </GameLayout>
  );
};
